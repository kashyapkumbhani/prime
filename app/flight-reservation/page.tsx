                ...
                <CardContent className="p-0">
                  ...
                  <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6">
                    ...
                    <div className="flex items-center space-x-2 text-blue-100">
                      ...
                      <span className="text-lg font-medium">Flight Reservation</span>
                    </div>
                    <p className="text-blue-100 text-sm mt-1">With Real PNR</p>
                  </div>
                      ...
                      <div className="space-y-3 text-sm">
                        ...
                        {departureDate && (
                          <div>
                            ...
                            <span className="font-medium">{format(departureDate, "MMM dd, yyyy")}</span>
                          </div>
                        )}
